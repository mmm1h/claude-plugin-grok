...
Present the export path and whether the bundle includes the log and rerun sidecar. Default output is `<job-id>.export.json` under the workspace root unless `--out` is set.
